...
from account.models import UserResetPasswordToken
from account.send_email import send_activation_email, send_password_reset_email
from account.serializers import RegisterSerializer, LogOutSerializer, ResetPasswordSerializer, \
    ResetpasswordConfirmSerializer
# from account.tasks import send_activation_email_task, send_password_reset_email_task
from account.utils import generate_reset_password_code
...
class ResetPasswordView(APIView):
    ...
    def post(self, request):
        ...
        return Response('Вам на почту отправлено сообщение с инмтрукцией по сбросу пороля', 200)
...
class PasswordResetConfirmView(APIView):
    ...
    def post(self, request):
        ...
        reset_code.delete()
        return Response('Вы успешео изменили пароль', 200)
